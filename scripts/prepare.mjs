...
async function downloadFile(url, targetPath) {
  // Ensure the target directory exists before writing. Some clean CI checkouts
  // do not contain empty asset directories, which caused ENOENT for the emoji font.
