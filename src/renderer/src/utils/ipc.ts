...
interface IpcApi {
  ...
  getLongXingAuthState: () => Promise<LongXingAuthState>
  verifyLongXingAuthorization: (payload: { accessKey: string }) => Promise<LongXingAuthState>
  logoutLongXingAuthorization: () => Promise<LongXingAuthState>
  // Mihomo API
...
export const getLongXingAuthState = (): Promise<LongXingAuthState> => ipc.getLongXingAuthState()
export const verifyLongXingAuthorization = (payload: { accessKey: string }): Promise<LongXingAuthState> =>
  ipc.verifyLongXingAuthorization(payload)
export const logoutLongXingAuthorization = (): Promise<LongXingAuthState> =>
  ipc.logoutLongXingAuthorization()
